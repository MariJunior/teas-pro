...
var ready = __webpack_require__(0);
...
ready(function () {
  var authorizationOpenButton = document.querySelector('.navigation-list__link--user');
  var popup = document.querySelector('#authorization-popup');
  var form = popup.querySelector('#authorization-from');
  var login = form.querySelector('#authorization-name');
  ...
  popup.classList.add('pop-up--hide');
  authorizationOpenButton.addEventListener('click', function (evt) {
    evt.preventDefault();
    openPopup();
  });
  authorizationOpenButton.addEventListener('keydown', function (evt) {
...
var objectFitImages = __webpack_require__(5);
...
ready(function () {
  var menu = document.querySelector('.page-header__wrap');
  var ancors = document.querySelectorAll('a[href^="#"');
  var headerHeight = menu.scrollHeight;
...
ready(function () {
  ...
  var marker = new mapboxgl.Marker({
    color: "#fcb51e",
    draggable: true
  }).setLngLat([30.212795, 59.943359]).setPopup(popup).addTo(map);
});
...
$(document).ready(function () {
  var image = document.querySelector('[data-fancybox]');
...
ready(function () {
  var tableRows = document.querySelectorAll('.products__table-row:nth-child(n + 7)');
  var moreBtn = document.querySelector('.products__more-btn');
  tableRows.forEach(function (tableRow) {
    tableRow.classList.add('visually-hidden');
  });
  moreBtn.addEventListener('click', function () {
    var moreBtnText = moreBtn.querySelector('.products__more-btn-text');
...
var iMask = __webpack_require__(13);

ready(function () {
  var feedbackFrom = document.querySelector('#feedback-from');
  var phoneInput = feedbackFrom.querySelector('#feedback-tel');
  var phoneSubmit = feedbackFrom.querySelector('#feedback-submit');
  var popup = document.querySelector('#success-popup');
  var closePopupBtn = popup.querySelector('.pop-up__btn');
  var maskOptions = {
    mask: '+{7} (000) 000-00-00'
  };
  var phoneMask = iMask.default(phoneInput, maskOptions);
  ...
  feedbackFrom.addEventListener('submit', function (evt) {
    evt.preventDefault();
    var phoneRegExp = /\+7\s\(9\d{2}\)\s\d{3}-\d{2}-\d{2}/;
    var err = 0;
    var xhr = new XMLHttpRequest();
    var formData = new FormData(feedbackFrom);
    var url = 'http://httpbin.org/response-headers?freeform='; // ТЕСТОВЫЙ АДРЕС, ВСТАВИТЬ СВОЙ
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "Masked", function() { return /* reexport */ base; });
__webpack_require__.d(__webpack_exports__, "createMask", function() { return /* reexport */ factory; });
__webpack_require__.d(__webpack_exports__, "MaskedRegExp", function() { return /* reexport */ masked_regexp; });
__webpack_require__.d(__webpack_exports__, "MaskedPattern", function() { return /* reexport */ masked_pattern; });
__webpack_require__.d(__webpack_exports__, "MaskedRange", function() { return /* reexport */ range; });
__webpack_require__.d(__webpack_exports__, "MaskedDate", function() { return /* reexport */ masked_date; });
__webpack_require__.d(__webpack_exports__, "MaskElement", function() { return /* reexport */ mask_element; });
__webpack_require__.d(__webpack_exports__, "HTMLMaskElement", function() { return /* reexport */ html_mask_element; });
__webpack_require__.d(__webpack_exports__, "HTMLContenteditableMaskElement", function() { return /* reexport */ html_contenteditable_mask_element; });
__webpack_require__.d(__webpack_exports__, "InputMask", function() { return /* reexport */ controls_input; });
__webpack_require__.d(__webpack_exports__, "MaskedEnum", function() { return /* reexport */ masked_enum; });
__webpack_require__.d(__webpack_exports__, "MaskedNumber", function() { return /* reexport */ masked_number; });
__webpack_require__.d(__webpack_exports__, "MaskedFunction", function() { return /* reexport */ masked_function; });
__webpack_require__.d(__webpack_exports__, "MaskedDynamic", function() { return /* reexport */ dynamic; });
...
/* harmony default export */ var esm = __webpack_exports__["default"] = (imask);
